...
gss <- read_dta("materials/AssignmentData/General_Social_survey_2022.dta")
...
eviction <- read.csv("materials/AssignmentData/State_Eviction_data.csv")
...
# Part 2, Question b, Setup
demographics <- read.csv("materials/AssignmentData/State_Demographics.csv")
