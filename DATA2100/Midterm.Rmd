...
knitr::opts_knit$set(
  root.dir = "C:/Users/edwar/OneDrive/Ed_Outlook_acct/OneDrive/Repositories/DATA2100"
)
...
```{r 2a, results = 'hide'}
# Part 2, Question a
tourist_expenditures <- read.csv(
  "materials/AssignmentData/average-expenditures-of-tourists-abroad.csv"
)
```
...
```{r 2c, results = 'hide'}
# Part 2, Question c
tourist_destinations <- read.csv("materials/AssignmentData/destination.csv")
```
<br>
...
```{r 3a, results = 'hide'}
# Part 3, Question a
genforward <- read_sav("materials/AssignmentData/genforward sept 2017.sav")
dim(genforward)
```
